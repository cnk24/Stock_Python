...
class Kiwoom(QAxContainer.QAxWidget):
    ...
    def eventConnect(self, returnCode):
        ...
        try:
            ...
            self.log_debug('eventConnect {}'.format(error))
        finally:
    ...
    def receiveRealData(self, code, realType, realData):
        ...
        """
        try:
            self.log_debug("[receiveRealData]")
            self.log_debug("({})".format(realType))
    ...
    def commConnect(self):
        ...
        self.loginLoop = QtCore.QEventLoop()
    ...
    def commRqData(self, requestName, trCode, inquiry, screenNo):
        ...
        self.requestLoop = QtCore.QEventLoop()
    ...
    def getConditionLoad(self):
        ...
        self.conditionLoop = QtCore.QEventLoop()
    ...
    def sendOrder(self, requestName, screenNo, accountNo, orderType, code, qty, price, hogaType, originOrderNo):
        ...
        self.orderLoop = QtCore.QEventLoop()
